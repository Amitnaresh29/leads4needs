...
export default function Resume1() {
  return <React.Fragment>
					    ...
					    <div className="row p-4 justify-content-center justify-content-md-between">
						    <div className="primary-info col-auto">
							    ...
							    <ul className="list-unstyled">
								    <li className="mb-2"><a className="text-link" href="#insta"><i className="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i>Steve.Doe@website.com</a></li>
								    <li><a className="text-link" href="#insta"><i className="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>0123 456 78900</a></li>
							    </ul>
						    </div>
						    <div className="secondary-info col-auto mt-2">
							    <ul className="resume-social list-unstyled">
					                <li className="mb-3"><a className="text-link" href="#insta"><span className="fa-container text-center me-2"><i className="fab fa-linkedin-in fa-fw"></i></span>linkedin.com/in/stevedoe</a></li>
					                <li className="mb-3"><a className="text-link" href="#insta"><span className="fa-container text-center me-2"><i className="fab fa-github-alt fa-fw"></i></span>github.com/username</a></li>
					                <li className="mb-3"><a className="text-link" href="#insta"><span className="fa-container text-center me-2"><i className="fab fa-codepen fa-fw"></i></span>codepen.io/username/</a></li>
					                <li><a className="text-link" href="#insta"><span className="fa-container text-center me-2"><i className="fas fa-globe"></i></span>yourwebsite.com</a></li>
							    </ul>
						    </div>
					    </div>
    ...
    <footer className="footer text-center pt-2 pb-5">
	     <small className="copyright">Designed with <i className="fas fa-heart"></i> by <a href="http://themes.3rdwavemedia.com" >Xiaoying Riley</a> for developers</small>
    </footer>
